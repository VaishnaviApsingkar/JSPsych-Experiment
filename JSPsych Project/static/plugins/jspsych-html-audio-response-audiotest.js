...
// This plugin was obtained from the following GitHub page: https://github.com/becky-gilbert/jsPsych/blob/audio-response/plugins/jspsych-html-audio-response.js
// This plugin has been modified from the latest version on 8/29/2021 in the following way:
// - In lines 214-220, added a Keyboard Listener that requires a button press - any key - to begin recording.

/**
 * jspsych-html-audio-response-audiotest
...
jsPsych.plugins["html-audio-response-audiotest"] = (function() {

    var plugin = {};

    plugin.info = {
        name: 'html-audio-response-audiotest',
        ...
        parameters: {
            ...
            recording_light: {
                ...
                default: '<div id="jspsych-html-audio-response-modified-light" '+
    ...
    plugin.trial = function(display_element, trial) {
        ...
        if(typeof trial.stimulus === 'undefined'){
            console.error('Required parameter "stimulus" missing in html-audio-response-audiotest');
        }
        ...
        function start_trial() {
            ...
            if (!trial.wait_for_mic_approval) {
                ...
                // RESEARCHER EDIT: Added a Keyboard Listener that requires a button press - any key - to begin recording.
                var keyboardListener = jsPsych.pluginAPI.getKeyboardResponse({
                        callback_function: start_recording,
